...
public class Versions {
    ...
    public static int postVersions(Map<String, String> params) throws IOException {
        Connector.connect(baseEndpoint, Connector.Methods.POST, params);
    ...
    public static int putRoot(Map<String, String> params) throws IOException {
        Connector.connect(rootEndpoint, Connector.Methods.PUT, params);
        return Connector.getResponseCode();
    }
    ...
    public static int postVersions() throws IOException {
        return postVersions(null);
    }
    ...
    public static int putRoot() throws IOException {
        return putRoot(null);
    }
